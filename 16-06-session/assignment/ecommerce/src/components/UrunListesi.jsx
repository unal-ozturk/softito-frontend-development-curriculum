...
export default function UrunListesi({
  products, // ürünler
  loading, //sayfa yüklenme bilgisi
  error, //veri gelmemesi durumundaki hata
  activeCategory, //mevcutta bulunan kategori ve/veya o kategoriye ait duruma geçilmesi
  onCategoryChange, //kategori değişiminde ilgili kategorinin gelmesi için kullanılan yapı
  onSelectProduct, //seçili ürüne dair bilgilerin aktarılması ve sonrasında işlenmesini sağlayan yapı
  onSepeteEkle, // ilgili/seçili eşyanında sepete eklenmesini sağlayan yapı
  searchTerm //  arama kutusuna yazılan anlık kelime / filtre metni
}) {

  // arama kutusundkai veri, gerçek ürün ile filtreleniyor
    ...
    <div className="app-card">
      ...
      <div className="app-card-body">
        <div className="etiket-izgara">
          {/* activateCategory ile ürünün türüne göre ayrılması ve listelenmesi */}
          ...
          <div className="urun-vitrini-alan">
            ...
            {/* lazy-loading yapısı - veriler gelmediyse ve hata yoksa yapı oluşuyor. hata varsa uyarı veriyor ve veriler yüklenince de ekrana çıktılanıyor */}
            {loading && !error ? (
                    ...
                    <div className="urun-kart-detay">
                      ...
                      <div className="urun-fiyat-grubu">
                        <div>
                          ...
                          {/* ürün butona basıldığında sadece o işlemi yapsın ve buton sinyali üstteki başta butonları tetiklemesin diye stopPropagation yapısı kullanılmış. onSepeteEkle yapısı ile ilgili item sepete ekleniyor */}
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            onSepeteEkle(item);
