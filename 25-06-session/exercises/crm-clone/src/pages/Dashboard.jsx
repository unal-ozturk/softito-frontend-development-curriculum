...
export default function Dashboard() {
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Şirket genel performansı ve anlık veriler.
          </p>
        </div>
          ...
          <div className="kpi-icon-wrapper bg-emerald-50 text-emerald-600">
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth="2"
                d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M12 8H12m0 8h.01"
              ></path>
            </svg>
          </div>
          <div className="kpi-details">
            <span className="kpi-label">Aylık Toplam Satış</span>
            <span className="kpi-value">{calculatedSales.toLocaleString('tr-TR')}TL</span>
            <span className="kpi-change text-emerald-600">
              <svg
                className="w-3.5 h-3.5"
                fill="none"
      ...
      <div className="grid-two-cols">
        ...
        <div className="card-container">
          <div className="card-title">
            ...
            <button type="button" onClick={() => dispatch(setActiveTab("messages"))} className="card-link"></button>
          </div>
  ...
  <p className="text-xs text-slate-400">Henüz Bir Aktivite Gerçekleştirilmedi.</p>
)
